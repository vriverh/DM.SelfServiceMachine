...
using DM.SelfServiceMachine.LocalService.Repository.VirtualRepository;
using DM.SelfServiceMachine.LocalService.WebApi;
...
namespace DM.SelfServiceMachine.LocalService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Tools.MachineInfo.configuration = Configuration;
            RegisterDI(services);
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            Tools.RawPrinterHelper.Logger = app.ApplicationServices.GetService<ILogger<Tools.RawPrinterHelper>>();
        }
